...
import { videoErrorsValidator } from '../../src/errors'
  ...
  it('should not create with incorrect input data', async () => {
    await request(app)
      ...
      .expect(HTTPStatuses.BADREQUEST400, {
        errorsMessages: [
          videoErrorsValidator.titleError,
          videoErrorsValidator.authorError,
          videoErrorsValidator.availableResolutionsError,
        ]
      })
  ...
  it('should not update with incorrect input data', async () => {
    const publicationDate = new Date().toISOString()
      ...
      .expect(HTTPStatuses.BADREQUEST400, {
        errorsMessages: [
          videoErrorsValidator.titleError,
          videoErrorsValidator.minAgeRestrictionError,
        ] 
      })
      ...
      .expect(HTTPStatuses.BADREQUEST400, {
        errorsMessages: [
          videoErrorsValidator.authorError,
          videoErrorsValidator.canBeDownloadedError,
          videoErrorsValidator.minAgeRestrictionError,
        ]
      })
      ...
      .expect(HTTPStatuses.BADREQUEST400, {
        errorsMessages: [
          videoErrorsValidator.publicationDateError,
        ]
      })
